! function () {
    var n = function () {
        ...
        o = [],
        u = function () {
            scale = window.devicePixelRatio || 1, e.width = window.innerWidth * scale, e.height = window.innerHeight *
                scale, t.scale(scale, scale)
        },
        d = ["#FF324A", "#31FFA6", "#206EFF", "#FFFF99"],
        c = function (e, a) {
            var i = {};
            return i.x = e, i.y = a, i.color = d[anime.random(0, d.length - 1)], i.radius = anime.random(n(), 2 * n()),
                i.draw = function () {
        ...
        m = function (e, i) {
            ...
            var r = function (n, e) {
                ...
                m = function (n, e) {
                    var a = {};
                    return a.x = n, a.y = e, a.color = d[anime.random(0, d.length - 1)], a.color = "#FFF", a.radius = 0,
                        a.alpha = 1, a.lineWidth = 6, a.draw = function () {
                            t.globalAlpha = a.alpha, t.beginPath(), t.arc(a.x, a.y, a.radius, 0, 2 * Math.PI, !0), t.lineWidth =
                                a.lineWidth, t.strokeStyle = a.color, t.stroke(), t.globalAlpha = 1
                        }, a
                }(e, i),
                s = anime({
                    targets: r,
